 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="MarkedDataSearchResult" type="{http://video.net/2/XProtectCSServerCommand}ArrayOfMarkedData" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class MarkedDataSearchResponse {
    ...
    @XmlElement(name = "MarkedDataSearchResult", nillable = true)
