 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="AlertsGetAroundWithSpanResult" type="{http://video.net/2/XProtectCSServerCommand}ArrayOfAlertOccurrence" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class AlertsGetAroundWithSpanResponse {
    ...
    @XmlElement(name = "AlertsGetAroundWithSpanResult", nillable = true)
