 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="BookmarkSearchTimeResult" type="{http://video.net/2/XProtectCSServerCommand}ArrayOfBookmark" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class BookmarkSearchTimeResponse {
    ...
    @XmlElement(name = "BookmarkSearchTimeResult", nillable = true)
