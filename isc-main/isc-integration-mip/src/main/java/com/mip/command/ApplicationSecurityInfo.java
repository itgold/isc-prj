 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="SmartClientSecurity" type="{http://video.net/2/XProtectCSServerCommand}SmartClientSecurityInfo" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class ApplicationSecurityInfo {
    ...
    @XmlElement(name = "SmartClientSecurity", nillable = true)
