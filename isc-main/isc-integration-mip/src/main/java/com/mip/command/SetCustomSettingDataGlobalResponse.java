 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="SetCustomSettingDataGlobalResult" type="{http://video.net/2/XProtectCSServerCommand}SetCustomSettingResultType" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class SetCustomSettingDataGlobalResponse {
    ...
    @XmlElement(name = "SetCustomSettingDataGlobalResult")
