 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="GetPresetsResult" type="{http://video.net/2/XProtectCSServerCommand}ArrayOfPresetInfo" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class GetPresetsResponse {
    ...
    @XmlElement(name = "GetPresetsResult", nillable = true)
