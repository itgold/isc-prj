 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="SetViewGroupDataResult" type="{http://video.net/2/XProtectCSServerCommand}SetViewGroupDataResultType" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class SetViewGroupDataResponse {
    ...
    @XmlElement(name = "SetViewGroupDataResult")
