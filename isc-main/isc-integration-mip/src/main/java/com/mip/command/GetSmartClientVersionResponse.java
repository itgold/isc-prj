 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="GetSmartClientVersionResult" type="{http://video.net/2/XProtectCSServerCommand}SmartClientVersion" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class GetSmartClientVersionResponse {
    ...
    @XmlElement(name = "GetSmartClientVersionResult", nillable = true)
