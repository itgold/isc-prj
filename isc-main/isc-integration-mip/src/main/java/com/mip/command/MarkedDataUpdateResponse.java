 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="MarkedDataUpdateResult" type="{http://video.net/2/XProtectCSServerCommand}MarkedDataResult" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class MarkedDataUpdateResponse {
    ...
    @XmlElement(name = "MarkedDataUpdateResult", nillable = true)
