 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="GetClientProfileResult" type="{http://video.net/2/XProtectCSServerCommand}ClientProfile" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class GetClientProfileResponse {
    ...
    @XmlElement(name = "GetClientProfileResult", nillable = true)
