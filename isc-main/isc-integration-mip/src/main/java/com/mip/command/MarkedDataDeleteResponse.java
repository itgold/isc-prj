 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="MarkedDataDeleteResult" type="{http://video.net/2/XProtectCSServerCommand}ArrayOfMarkedDataResult" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class MarkedDataDeleteResponse {
    ...
    @XmlElement(name = "MarkedDataDeleteResult", nillable = true)
