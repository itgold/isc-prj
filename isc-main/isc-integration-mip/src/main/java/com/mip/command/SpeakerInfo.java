 ...
 *         &amp;lt;element name="SpeakerSecurity" type="{http://video.net/2/XProtectCSServerCommand}SpeakerSecurityInfo" minOccurs="0"/&amp;gt;
    ...
    extends DeviceInfo
{
    ...
    @XmlElement(name = "SpeakerSecurity", nillable = true)
