            ...
            <ThemeProvider theme={navbarTheme}>
                <div id="fuse-navbar" className={clsx(classes.wrapper, folded && classes.wrapperFolded)}>
                    <div
                        ...
                        onMouseEnter={() => foldedAndClosed && showOnHover && dispatch(Actions.navbarOpenFolded())}
                        onMouseLeave={() => foldedAndOpened && showOnHover && dispatch(Actions.navbarCloseFolded())}
