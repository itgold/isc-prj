...
interface AlertIgnoreDialogProps {
 ...
 */
const AlertIgnoreDialog = forwardRef(
    (props: AlertIgnoreDialogProps, ref: React.Ref<IAlertDialogDialog> | undefined): JSX.Element => {
                ...
                return new Promise<boolean>(resolve => {
                    eventsService
                        .updateAlert({
                            alertId,
                            notes,
                            alertStatus: AlertStatus.IGNORE,
                        })
                        .then(() => resolve(true))
                        .catch(() => resolve(false));
                });
        ...
        return (
            ...
            >
                <DialogTitle id="alert-dialog-title">Ignore Alert</DialogTitle>
                <DialogContent>
...
export default AlertIgnoreDialog;
