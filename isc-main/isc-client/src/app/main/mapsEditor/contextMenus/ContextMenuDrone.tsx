...
/**
 * TODO: TBD
 * Display the context menu for drones
 */
export default function ContextMenuDrone(props: IContextMenuProps): JSX.Element {
    ...
    return (
        <List dense disablePadding className={classes.root}>
            <ListItem dense>
                ...
                <ListItemText primary={selectedFeature?.getProperties().data?.status} secondary="Status" />
            </ListItem>
