...
@Slf4j
@Component
public class OpenDoorActionHandler implements IDeviceActionHandler {

    private static final String ACTION = "openDoor";
    ...
    public DeviceActionResultDto execute(DeviceActionDto action) {
        ...
        if (composite != null) {
            result = composite.openDoor(DeviceActionAccumulator.build());
        } else {
