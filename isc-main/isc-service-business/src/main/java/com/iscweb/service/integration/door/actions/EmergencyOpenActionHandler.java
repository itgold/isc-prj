...
@Slf4j
@Component
public class EmergencyOpenActionHandler implements IDeviceActionHandler {

    private static final String ACTION = "emergencyOpen";
    ...
    public DeviceActionResultDto execute(DeviceActionDto action) {
        ...
        if (composite != null) {
            result = composite.emergencyOpen(DeviceActionAccumulator.build());
        } else {
