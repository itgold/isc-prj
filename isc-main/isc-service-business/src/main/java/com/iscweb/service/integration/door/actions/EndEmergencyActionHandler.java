...
@Slf4j
@Component
public class EndEmergencyActionHandler implements IDeviceActionHandler {

    private static final String ACTION = "endEmergency";
    ...
    public DeviceActionResultDto execute(DeviceActionDto action) {
        ...
        if (composite != null) {
            result = composite.endEmergency(DeviceActionAccumulator.build());
        } else {
